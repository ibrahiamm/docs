...
define('API_KEY','2053076091:AAF-5cvVak0anh2vcd_KQy5SyecO2s_-n9s');
...
if($message && (strpos($join,'"status":"left"') or strpos($join,'"Bad Request: USER_ID_INVALID"') or strpos($join,'"status":"wwwwibrahimcom"'))!== false){
bot('sendMessage', [
'chat_id'=>$chat_id,
'text'=>"
...
[♻️إضغط هنا وتابع جديدنا♻️](https://t.me/wwwwibrahimcom)
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text'=>'🔧 - صنع بوت - 🔧','callback_data'=>'addbot'],['text'=>'🗑 - حذف بوت - 🗑','callback_data'=>'delete']],[['text'=>'📝 - كيف اصنع بوت - 📝','callback_data'=>'help']],[['text'=>'📡 - إضغط هنا وتابع جديدنا - 📡','url'=>'https://t.me/ibrmmi']],],])]);}
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'🔧 - صنع بوت - 🔧','callback_data'=>'addbot'],['text'=>'🗑 - حذف بوت - 🗑','callback_data'=>'delete']],[['text'=>'📝 - كيف اصنع بوت - 📝','callback_data'=>'help']],[['text'=>'📡 - إضغط هنا وتابع جديدنا - 📡','url'=>'https://t.me/ibrmmi']],],])]);}
if($data == 'help'){
bot('editMessageText',['chat_id'=>$chat_id2,'message_id'=>$message_id,'text'=>"
...
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text'=>'الصفحة الرئيسية 🏠️','callback_data'=>'home']],[['text'=>'📡 - إضغط هنا وتابع جديدنا - 📡','url'=>'https://t.me/wwwwibrahimcom']],],])]);}
//========================================================================
